...
public record GetPreviousMessageHandler(ServerController controller) implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        Message message = controller.getPreviousMessage(token, currentId);
        if (message == null ) {
